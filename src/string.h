...
namespace AnsiGL
{
    ...
    const int DEFAULT_LINE_WIDTH = 78;  //! Default line width for
                                        //! word-wrap functions --
                                        //! default terminal width is 80,
                                        //! 79 should be max, 78 to be
                                        //! safe because some terminals
                                        //! handle it strangely
    ...
    //! @class String
    //! @brief A std::string-esque foundation that allows for potentially elaborate glyphs.
    ...
    public:
        ...
        //
        // NOTE: Just about every derived class will need to have its
        // own version of these function...any derived classes that
        // have 'encoding' within the std::string type, for sure
        ...
        // NOTE: Many derived classes will need to consider having their own version of this function as well
        ...
        //! Renders to a standard std::string
        ...
        //! Reports the current number of lines in this string
        ...
        //! Eats the whitespace at the front of the string
        virtual void RemoveLeadingSpace()
        {
        ...
        //! Eats the whitespace at the end of the string
        virtual void RemoveTrailingSpace()
        {
        ...
        //! Capitalizes everything in the string
        ...
        //! Lowercases (is this even a word?) everything the string
        ...
        //! Capitalize the first character of the string (maybe expand
        //! to after periods as well?  But what about
        //! abbreviations?...)
    ...
    //! @class ustring
    //! @brief A perfect std::string implementation for uchar. (ideally).
    //!
    //! ustring is an extension of String< uchar >.
    ...
    //! @class astring
    //! @brief A perfect std::string implementation for achar. (ideally)
    //!
